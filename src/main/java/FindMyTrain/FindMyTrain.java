...
public class FindMyTrain {
    ...
    public static void main(String[] args) {
        ...
        Schedule s1 = new Schedule(train1,station1,"9 AM","9:05 AM",p1);
        Schedule s2 = new Schedule(train1,station2,"10 AM","10:02AM",p2);
        ...
        // let's find the train between stations
